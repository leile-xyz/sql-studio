...
const table = { uid: 'table-1', name: 'orders', schema: '', db: 'sales_db', expanded: false };
const database = { uid: 'db-1', name: 'sales_db', dbType: 'mysql', expanded: false, tables: [table] };
const instance = { uid: 'instance-1', name: 'warehouse', dbType: 'mysql', expanded: false, dbs: [database] };
